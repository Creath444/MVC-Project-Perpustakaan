            ...
            <div class="page-header">
              ...
              <a href="<?=base_url?>/kategori/tambah">
                ...
                <div class="search-field d-none d-md-block">
                  <form class="d-flex align-items-center h-100" action="<?=base_url?>/kategori/cari" method="POST" >
                  ...
                  <?php foreach ($data['kategori'] as $row) :?>
                   <tr class="table-info ">
                    ...
                    <td>
                      ...
                      <a href="<?= base_url; ?>/kategori/edit/<?= $row['id'] ?>">
                        <button type="button" class="btn btn-inverse-info btn-icon">
                          <i class="mdi mdi-table-edit"></i>
                        </button>
                      </a>
                      <!-- link controller Kategori/hapus -->
                      <a href="<?= base_url; ?>/kategori/hapus/<?= $row['id'] ?>" onclick="return confirm('Hapus data?');"><button type="button" class="btn btn-inverse-danger btn-icon">
